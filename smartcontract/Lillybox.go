...
// FlushKlayBalance is a paid mutator transaction binding the contract method 0x02ad0034.
//
// Solidity: function flushKlayBalance(uint256 _amount, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxTransactor) FlushKlayBalance(opts *bind.TransactOpts, _amount *big.Int, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.contract.Transact(opts, "flushKlayBalance", _amount, _lilAmount)
}

// FlushKlayBalance is a paid mutator transaction binding the contract method 0x02ad0034.
//
// Solidity: function flushKlayBalance(uint256 _amount, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxSession) FlushKlayBalance(_amount *big.Int, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushKlayBalance(&_Lillybox.TransactOpts, _amount, _lilAmount)
}

// FlushKlayBalance is a paid mutator transaction binding the contract method 0x02ad0034.
//
// Solidity: function flushKlayBalance(uint256 _amount, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxTransactorSession) FlushKlayBalance(_amount *big.Int, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushKlayBalance(&_Lillybox.TransactOpts, _amount, _lilAmount)
}
