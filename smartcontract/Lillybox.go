...
// LillyboxStakeRequest is an auto generated low-level Go binding around an user-defined struct.
type LillyboxStakeRequest struct {
	Amount              *big.Int
	StakedBlock         *big.Int
...
// EstimateRewards is a free data retrieval call binding the contract method 0x819f8f11.
//
// Solidity: function estimateRewards(address user, uint256 index) view returns(uint256)
func (_Lillybox *LillyboxCaller) EstimateRewards(opts *bind.CallOpts, user common.Address, index *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Lillybox.contract.Call(opts, &out, "estimateRewards", user, index)
...
//
// Solidity: function estimateRewards(address user, uint256 index) view returns(uint256)
func (_Lillybox *LillyboxSession) EstimateRewards(user common.Address, index *big.Int) (*big.Int, error) {
	return _Lillybox.Contract.EstimateRewards(&_Lillybox.CallOpts, user, index)
}

// EstimateRewards is a free data retrieval call binding the contract method 0x819f8f11.
//
// Solidity: function estimateRewards(address user, uint256 index) view returns(uint256)
func (_Lillybox *LillyboxCallerSession) EstimateRewards(user common.Address, index *big.Int) (*big.Int, error) {
	return _Lillybox.Contract.EstimateRewards(&_Lillybox.CallOpts, user, index)
}
...
// ShowTable is a free data retrieval call binding the contract method 0x601a62c8.
//
// Solidity: function showTable() view returns((uint256,uint256,uint256,uint8)[])
func (_Lillybox *LillyboxCaller) ShowTable(opts *bind.CallOpts) ([]LillyboxStakeRequest, error) {
	var out []interface{}
	err := _Lillybox.contract.Call(opts, &out, "showTable")

	if err != nil {
		return *new([]LillyboxStakeRequest), err
	}

	out0 := *abi.ConvertType(out[0], new([]LillyboxStakeRequest)).(*[]LillyboxStakeRequest)
...
//
// Solidity: function showTable() view returns((uint256,uint256,uint256,uint8)[])
func (_Lillybox *LillyboxSession) ShowTable() ([]LillyboxStakeRequest, error) {
	return _Lillybox.Contract.ShowTable(&_Lillybox.CallOpts)
}

// ShowTable is a free data retrieval call binding the contract method 0x601a62c8.
//
// Solidity: function showTable() view returns((uint256,uint256,uint256,uint8)[])
func (_Lillybox *LillyboxCallerSession) ShowTable() ([]LillyboxStakeRequest, error) {
	return _Lillybox.Contract.ShowTable(&_Lillybox.CallOpts)
}

// ShowWallet is a free data retrieval call binding the contract method 0x262655bf.
//
// Solidity: function showWallet(address user) view returns((uint256,bool))
...
// Donation is a paid mutator transaction binding the contract method 0xdcf38427.
//
// Solidity: function donation(address destUser, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxTransactor) Donation(opts *bind.TransactOpts, destUser common.Address, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.contract.Transact(opts, "donation", destUser, _lilAmount)
}

// Donation is a paid mutator transaction binding the contract method 0xdcf38427.
//
// Solidity: function donation(address destUser, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxSession) Donation(destUser common.Address, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.Donation(&_Lillybox.TransactOpts, destUser, _lilAmount)
}

// Donation is a paid mutator transaction binding the contract method 0xdcf38427.
//
// Solidity: function donation(address destUser, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxTransactorSession) Donation(destUser common.Address, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.Donation(&_Lillybox.TransactOpts, destUser, _lilAmount)
}

// FlushDonationReward is a paid mutator transaction binding the contract method 0x2be20779.
//
// Solidity: function flushDonationReward(uint256 _amount, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxTransactor) FlushDonationReward(opts *bind.TransactOpts, _amount *big.Int, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.contract.Transact(opts, "flushDonationReward", _amount, _lilAmount)
}

// FlushDonationReward is a paid mutator transaction binding the contract method 0x2be20779.
//
// Solidity: function flushDonationReward(uint256 _amount, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxSession) FlushDonationReward(_amount *big.Int, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushDonationReward(&_Lillybox.TransactOpts, _amount, _lilAmount)
}

// FlushDonationReward is a paid mutator transaction binding the contract method 0x2be20779.
//
// Solidity: function flushDonationReward(uint256 _amount, uint256 _lilAmount) payable returns(bool)
func (_Lillybox *LillyboxTransactorSession) FlushDonationReward(_amount *big.Int, _lilAmount *big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushDonationReward(&_Lillybox.TransactOpts, _amount, _lilAmount)
}

// FlushReward is a paid mutator transaction binding the contract method 0x6a59e09f.
//
// Solidity: function flushReward(uint256[] index) returns(uint256)
func (_Lillybox *LillyboxTransactor) FlushReward(opts *bind.TransactOpts, index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.contract.Transact(opts, "flushReward", index)
}

// FlushReward is a paid mutator transaction binding the contract method 0x6a59e09f.
//
// Solidity: function flushReward(uint256[] index) returns(uint256)
func (_Lillybox *LillyboxSession) FlushReward(index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushReward(&_Lillybox.TransactOpts, index)
}

// FlushReward is a paid mutator transaction binding the contract method 0x6a59e09f.
//
// Solidity: function flushReward(uint256[] index) returns(uint256)
func (_Lillybox *LillyboxTransactorSession) FlushReward(index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushReward(&_Lillybox.TransactOpts, index)
}

// FlushUnstakePendingBalance is a paid mutator transaction binding the contract method 0x1207f869.
//
// Solidity: function flushUnstakePendingBalance(uint256[] index) payable returns(bool)
func (_Lillybox *LillyboxTransactor) FlushUnstakePendingBalance(opts *bind.TransactOpts, index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.contract.Transact(opts, "flushUnstakePendingBalance", index)
}

// FlushUnstakePendingBalance is a paid mutator transaction binding the contract method 0x1207f869.
//
// Solidity: function flushUnstakePendingBalance(uint256[] index) payable returns(bool)
func (_Lillybox *LillyboxSession) FlushUnstakePendingBalance(index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushUnstakePendingBalance(&_Lillybox.TransactOpts, index)
}

// FlushUnstakePendingBalance is a paid mutator transaction binding the contract method 0x1207f869.
//
// Solidity: function flushUnstakePendingBalance(uint256[] index) payable returns(bool)
func (_Lillybox *LillyboxTransactorSession) FlushUnstakePendingBalance(index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.FlushUnstakePendingBalance(&_Lillybox.TransactOpts, index)
}
...
//
// Solidity: function stake() payable returns(bool)
func (_Lillybox *LillyboxTransactor) Stake(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Lillybox.contract.Transact(opts, "stake")
}

// Stake is a paid mutator transaction binding the contract method 0x3a4b66f1.
//
// Solidity: function stake() payable returns(bool)
func (_Lillybox *LillyboxSession) Stake() (*types.Transaction, error) {
	return _Lillybox.Contract.Stake(&_Lillybox.TransactOpts)
}

// Stake is a paid mutator transaction binding the contract method 0x3a4b66f1.
//
// Solidity: function stake() payable returns(bool)
func (_Lillybox *LillyboxTransactorSession) Stake() (*types.Transaction, error) {
	return _Lillybox.Contract.Stake(&_Lillybox.TransactOpts)
}
...
//
// Solidity: function unstake(uint256[] index) returns(bool)
func (_Lillybox *LillyboxTransactor) Unstake(opts *bind.TransactOpts, index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.contract.Transact(opts, "unstake", index)
}

// Unstake is a paid mutator transaction binding the contract method 0xe449f341.
//
// Solidity: function unstake(uint256[] index) returns(bool)
func (_Lillybox *LillyboxSession) Unstake(index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.Unstake(&_Lillybox.TransactOpts, index)
}

// Unstake is a paid mutator transaction binding the contract method 0xe449f341.
//
// Solidity: function unstake(uint256[] index) returns(bool)
func (_Lillybox *LillyboxTransactorSession) Unstake(index []*big.Int) (*types.Transaction, error) {
	return _Lillybox.Contract.Unstake(&_Lillybox.TransactOpts, index)
}
...
// FilterNewStaking is a free log retrieval operation binding the contract event 0x680a0e2e97ad7c29da7985e37b699f19857c055166f801e50d90661eae30fcc3.
//
// Solidity: event NewStaking(address indexed user, uint256 amount, uint256 blocknumber, uint256 index)
...
// WatchNewStaking is a free log subscription operation binding the contract event 0x680a0e2e97ad7c29da7985e37b699f19857c055166f801e50d90661eae30fcc3.
//
// Solidity: event NewStaking(address indexed user, uint256 amount, uint256 blocknumber, uint256 index)
...
// ParseNewStaking is a log parse operation binding the contract event 0x680a0e2e97ad7c29da7985e37b699f19857c055166f801e50d90661eae30fcc3.
//
// Solidity: event NewStaking(address indexed user, uint256 amount, uint256 blocknumber, uint256 index)
